...
Author 支持基于 Supabase 的多设备实时云同步，让你在不同设备上无缝切换创作。
...
|------|:---------:|:------------------:|
| 云同步 | ✓ 内置 | 需配置 Supabase |
| 配置难度 | 无需配置 | 需创建 Supabase 项目 |
| 数据归属 | 官方服务器 | 自建 Supabase |

> 💡 桌面客户端已内置官方云同步服务器，无需额外配置 Supabase，登录即用。
